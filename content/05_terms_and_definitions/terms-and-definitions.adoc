...
Multispectral material appears in imagery as 3 to 10 wider bands. +
Hyperspectral material appears as hundreds of narrow bands.
...
A vector that is perpendicular to a given object, surface, or geometric
