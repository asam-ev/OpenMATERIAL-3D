...
The references are given in the `externalAssetReferences` property, a list of pairs of a parent node and a reference to a _3D asset_ file, see xref:../07_geometry/asset-schema.adoc#_externalassetreferences[].
...
The `materialReplacement` property of the _3D asset_ file resolves this without modifying the _3D data file_, see xref:../07_geometry/asset-schema.adoc#_materialreplacement[].
...
The `geometryProperties` property of the _3D asset_ file assigns such properties to individual nodes of the _3D data file_, see xref:../07_geometry/asset-schema.adoc#_geometryproperties[].
...
They are defined in the _3D asset_ file using the `lightDefinitions` property, see xref:../07_geometry/asset-schema.adoc#_lightdefinitions[].
...
Emissive materials are defined in the _3D data file_ and mapped in the _3D asset_ file using the `emissiveLightMapping` property, see xref:../07_geometry/asset-schema.adoc#_emissivelightmapping[].
