...
The references are given in the xref:../07_geometry/asset-schema.adoc#{empty}_externalassetreferences[externalAssetReferences] property of the _3D asset_ file, as a list of pairs of a parent node and a path to the _3D asset_ file of the external asset.
...
The xref:../07_geometry/asset-schema.adoc#{empty}_materialreplacements[materialReplacements] property of the _3D asset_ file resolves this without modifying the _3D data file_.
...
The xref:../07_geometry/asset-schema.adoc#{empty}_geometryproperties[geometryProperties] property of the _3D asset_ file assigns such properties to individual nodes of the _3D data file_.
...
They are defined in the _3D asset_ file using the xref:../07_geometry/asset-schema.adoc#{empty}_lightdefinitions[lightDefinitions] property.
...
Emissive materials are defined in the _3D data file_ and mapped in the _3D asset_ file using the xref:../07_geometry/asset-schema.adoc#{empty}_emissivelightmapping[emissiveLightMapping] property.
