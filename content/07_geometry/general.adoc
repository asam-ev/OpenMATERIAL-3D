...
The xref:../07_geometry/asset-schema.adoc#{empty}_materialreplacement[materialReplacement] property of the _3D asset_ file resolves this without modifying the _3D data file_.
