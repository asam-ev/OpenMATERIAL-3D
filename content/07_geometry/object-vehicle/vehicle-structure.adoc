...
This group contains all parts of a door located at the rear of the vehicle, such as the trunk lid. It also includes the door's interior parts, as they move together as a single unit.
...
Position lights are usually small, low-intensity, orange lights.
...
This group contains all parts of the movable structure that holds the mirror on the vehicle's right side.
The mirror view automatically adjusts when the angle of the joint changes.
...
The transform of this group shall only be used to implement translational movement of the wheel.
Rotational movement of the wheel shall be applied simultaneously to the transforms of both child
groups, Grp_Wheel_Steering and Grp_Wheel_Steering_Rotating, whereby the rolling movement of the wheel
shall only be taken into account for the latter. See the following sections for details.

Suspension deflection is represented by translation along the z-axis.
Zero translation along all axes is defined under neutral load conditions.
...
This group contains all parts of a wheel that follow the steering motion but not the rolling movement of the wheel, such as brake calipers.
...
Zero rotation around all axes is defined under neutral load conditions.
...
Therefore, rotational movement due to wheel steering, wheel camber, and the rolling movement of the wheel shall be applied to this group.

Wheel steering is represented by rotation around the z-axis.
Wheel camber is defined by a rotation around the x-axis.
The rolling movement of the wheel is defined by a rotation around the y-axis.
Zero rotation around all axes is defined under neutral load conditions.
...
`<seat_row>` denotes a row of seats, counted from the front to the rear, starting with 0.
...
| *Origin*
| Center of the joint to the main vehicle or to the parent vehicle part
