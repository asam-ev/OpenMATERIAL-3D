...
For the implementation of semantic ASAM OpenSCENARIO https://www.asam.net/static_downloads/ASAM_OpenSCENARIO_V1.2.0_Model_Documentation/modelDocumentation/content/TrafficSignalState.html[TrafficSignalStates], individual bulbs can be toggled according to their `<bulb_idx>`, e.g. "off;off;on" toggles Grp_Bulb_<0> and Grp_Bulb_<1> off, and Grp_Bulb_<2> on.
