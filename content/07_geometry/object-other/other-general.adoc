...
Definitions in type-specific object classes take precedence over the specifications in the other object class.
...
The x-axis of the coordinate system should point to the front of the object (if applicable), the z-axis should point vertically upwards, and the y-axis should point laterally to complete the right-handed coordinate system.