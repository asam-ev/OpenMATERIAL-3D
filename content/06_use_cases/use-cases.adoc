...
|*Relevant OpenMATERIAL 3D segments*|Geometry and Material
|*Influencing standards*            |FMI cite:[fmi], ASAM OSI (OSMP) cite:[osi], ASAM OpenLABEL cite:[ola], ASAM OpenDRIVE cite:[odr], ASAM OpenSCENARIO XML cite:[osc]
...
|===
|*Description*                      |As a perception algorithm developer, I want to use simulated environments for model training and testing, because collecting real-world information is too expensive and inconvenient.
|*Relevant OpenMATERIAL 3D segments*|Geometry and Material
|*Influencing standards*            |ASAM OSI cite:[osi], ASAM OpenSCENARIO XML cite:[osc], ASAM OpenDRIVE cite:[odr]
